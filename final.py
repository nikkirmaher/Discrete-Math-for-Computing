...
def bot_goes(board):
	...
	for i in range(0,9):
		if board[i]=='X':
			...
			ocount=ocount+1
	if xcount==1 and ocount==0 and board[4]!='X':
		middle(board)
	elif xcount==1 and ocount==1 and board[4]!='X':
		middle(board)
...
def endgame():
	...
	time.sleep(2)
	print('This game is programmed so that I always win or it always ends in a draw.')
	time.sleep(5)
	print('')
	print('Looking at it as a Combinatorics problem, ')
	time.sleep(2)
	print('there are 9 total spaces and two players...')
	time.sleep(2)
	print('')
	print('Assuming one player has a maximum of 5 turns, and the other 4 turns,')
	time.sleep(2)
	print('we can break the problem up into 4 different combinatoric scenarios: ')
	time.sleep(3)
	print('1. 3 Xs and 2 Os (X wins)')
	print('2. 3 Xs and 3 Os (O wins)')
	print('3. 4 Xs and 3 Os (X wins)')
	print('4. 4 Xs and 4 Os (O wins)')
	print('5. 5 Xs and 4 Os (X wins)')
	time.sleep(5)
	print('Considering the possible combinations for each scenario...')
	time.sleep(2)
	print('1. 8 x C(6,2) = 120')
	print('2. 8 x C(6,3) - 12 = 148')
	print('3. 8 x 6 x C(5,3) - 12 x C(3,1) = 444')
	print('4. 8 x 6 x C(5,4) - 12 x 3 x 2 = 168')
	print('5. 8 x C(6,2) - 12 x C(3,2) - 22 = 62')
	time.sleep(3)
	print('')
	print('120 + 148 + 444 + 168 + 62 = 942 possible winning scenarios.')
	...
	print('')
	time.sleep(5)
	print('The program takes into account the probability for it to win based on the possible moves that you might make...')
	time.sleep(5)
	print('')
